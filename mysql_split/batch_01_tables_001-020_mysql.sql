...
-- ----------------------------
-- Table structure for ailpha_aiAnalysis_algorithm
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_aiAnalysis_algorithm`;
CREATE TABLE `ailpha_aiAnalysis_algorithm`  (
  `algorithmId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '算法id',
  `algorithmName` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '算法名称',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `other` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '误差描述',
  `paper` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '论文(格式[{\"content\":\"论文描述\",\"info\":\"\"}])',
  `patent` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '专利(格式[{\"content\":\"专利描述\",\"info\":\"专利号\"}])',
  PRIMARY KEY (`algorithmId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_aiAnalysis_algorithm
-- ----------------------------
...
-- ----------------------------
-- Table structure for ailpha_aiAnalysis_data
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_aiAnalysis_data`;
CREATE TABLE `ailpha_aiAnalysis_data`  (
  `id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模型数据id',
  `originalData` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分析结果原始数据',
  `uiData` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '前端展示结果数据',
  `createTime` bigint(20) NULL DEFAULT NULL,
  `modelId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模型id',
  `algorithmId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '算法id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_aiAnalysis_data
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_aiAnalysis_scene
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_aiAnalysis_scene`;
CREATE TABLE `ailpha_aiAnalysis_scene`  (
  `sceneId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '场景id',
  `sceneNo` int(10) NOT NULL COMMENT '场景号',
  `modelId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模型id',
  `algorithmId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '算法id',
  `isenable` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'true' COMMENT '是否启用',
  `other` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '其他',
  PRIMARY KEY (`sceneId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_aiAnalysis_scene
-- ----------------------------
...
-- ----------------------------
-- Table structure for ailpha_metric
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_metric`;
CREATE TABLE `ailpha_metric`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `metricKey` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `source` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `filterStrategyStr` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `filterStrategy` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `groupBy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `toAlarm` int(16) NULL DEFAULT NULL,
  `uiJson` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `siddhiJson` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `createTime` bigint(32) NULL DEFAULT NULL,
  `updateTime` bigint(32) NULL DEFAULT NULL,
  `window` bigint(32) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_metric
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_model
-- ----------------------------
...
CREATE TABLE `ailpha_model`  (
  ...
  `type` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '模型类型',
  `modelName` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '英文短名',
  `chineseName` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '中文名',
  `killChain` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '攻击链',
  `attackIntent` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '攻击意图',
  `attackMethod` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '攻击方法',
  `attackStrategy` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '攻击策略',
  `severity` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '告警级别',
  `source` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '数据源',
  `toAlarm` tinyint(3) NOT NULL COMMENT '是否输出到安全告警，0:不输出，1:输出',
  `description` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '描述',
  `suggest` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '建议',
  `isCustom` tinyint(3) NOT NULL COMMENT '定制类型：0:非定制 1:定制',
  `state` tinyint(3) NOT NULL COMMENT '状态，0:禁用，1:启用',
  `uiJson` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'UI对接的json',
  `isWafRule` smallint(2) NULL DEFAULT NULL,
  `usedKeyStr` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `createTime` bigint(32) NULL DEFAULT NULL,
  `updateTime` bigint(32) NULL DEFAULT NULL,
  `tags` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '标签',
  `filterStr` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '模型过滤条件',
  `isQuoted` smallint(2) NULL DEFAULT NULL COMMENT '模型是否被引用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `modelName`(`modelName`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_model
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_model_change
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_model_change`;
CREATE TABLE `ailpha_model_change`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uuid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `enable` tinyint(4) NOT NULL DEFAULT -1,
  `toAlarm` tinyint(4) NOT NULL DEFAULT -1,
  `addOrUpdate` tinyint(4) NOT NULL DEFAULT -1,
  `del` tinyint(4) NOT NULL DEFAULT -1,
  `addOrUpdateTime` bigint(10) NOT NULL DEFAULT 0,
  `delTime` bigint(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_model_change
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_model_factory
-- ----------------------------
...
CREATE TABLE `ailpha_model_factory`  (
  ...
  `toAlarm` tinyint(4) NULL DEFAULT NULL,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_model_factory
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_model_user_status
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_model_user_status`;
CREATE TABLE `ailpha_model_user_status`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'model:uuid, metric:metricId',
  `type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'model / metric',
  `enable` tinyint(2) NULL DEFAULT NULL,
  `to_alarm` tinyint(2) NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_model_user_status
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_sub_metric
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_sub_metric`;
CREATE TABLE `ailpha_sub_metric`  (
  `metricId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `metricName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `action` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `field` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `metricKey` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `metricJson` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `groupId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `customized` int(16) NULL DEFAULT NULL,
  `active` int(16) NULL DEFAULT NULL,
  `canConfig` int(16) NULL DEFAULT NULL,
  `createTime` bigint(32) NULL DEFAULT NULL,
  `updateTime` bigint(32) NULL DEFAULT NULL,
  `usedKeyStr` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
...
-- ----------------------------
-- Records of ailpha_sub_metric
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ailpha_topology
-- ----------------------------
DROP TABLE IF EXISTS `ailpha_topology`;
CREATE TABLE `ailpha_topology`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uuid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `dataStr` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '数据',
  `startTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '起始时间',
  ...
  `costTime` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '花费时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ailpha_topology
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for dictionary_file_md5
-- ----------------------------
...
-- ----------------------------
-- Records of dictionary_file_md5
-- ----------------------------
...
-- ----------------------------
-- Table structure for engine_change
-- ----------------------------
...
-- ----------------------------
-- Table structure for ice_attack
-- ----------------------------
DROP TABLE IF EXISTS `ice_attack`;
CREATE TABLE `ice_attack`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `intent` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '攻击类型',
  `strategy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '攻击策略',
  `method` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '攻击方法',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ice_attack
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ice_label
-- ----------------------------
DROP TABLE IF EXISTS `ice_label`;
CREATE TABLE `ice_label`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `fields` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '展示字段',
  `num` bigint(4) NOT NULL COMMENT '字典表代号',
  `scene` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分析场景',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ice_label
-- ----------------------------

-- ----------------------------

-- ----------------------------
-- Table structure for ice_tag
-- ----------------------------
DROP TABLE IF EXISTS `ice_tag`;
CREATE TABLE `ice_tag`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `tagname` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '标签名称',
  `input` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '输入的搜索条件',
  `isFactory` bigint(4) NULL DEFAULT NULL COMMENT '是否出厂',
  `indexStr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '检索分析快速查询标签默认索引',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for ice_tag_order
-- ----------------------------
DROP TABLE IF EXISTS `ice_tag_order`;
CREATE TABLE `ice_tag_order`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `tag_order` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '展示顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ice_tag_order
-- ----------------------------
...
-- ----------------------------
-- Table structure for patrol_comp_alert
-- ----------------------------
DROP TABLE IF EXISTS `patrol_comp_alert`;
CREATE TABLE `patrol_comp_alert`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '唯一ID',
  `type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型:logstash/es_cluster_simple/baas_job/webapp/hadoop/zookeeper/kafka/es_node/host_info',
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '告警名称，关联core_dict表patrol_alert_title类型',
  `alert_level` tinyint(2) NOT NULL COMMENT '告警级别,1-低，2-中，3高',
  `module_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模块分类，关联core_dict表patrol_alert_module类型',
  `detail` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '告警详情',
  `alert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '告警时间',
  `valid_flag` tinyint(1) NULL DEFAULT 1 COMMENT '是否有效，1-有效，0-无效',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `del_flag` tinyint(1) NULL DEFAULT NULL COMMENT '是否删除，0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '巡检告警表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of patrol_comp_alert
-- ----------------------------
...
CREATE TABLE `reputation`  (
  `dateip` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `repu` double NULL DEFAULT NULL,
  `detail` mediumtext CHARACTER SET utf8 COLLATE utf8_bin NULL,
  PRIMARY KEY (`dateip`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
