...
-- ----------------------------
DROP SEQUENCE IF EXISTS "t_virus_kill_history_id_seq" CASCADE;
...
CREATE TABLE "t_virus_kill_history" (
  ...
  "action" "t_virus_kill_history_action" NOT NULL DEFAULT '病毒查杀'::t_virus_kill_history_action,
...
-- ============================
-- ----------------------------
-- Primary Keys structure for table t_virus_kill_history
-- ----------------------------
