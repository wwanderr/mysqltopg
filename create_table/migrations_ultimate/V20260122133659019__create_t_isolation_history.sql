...
-- ----------------------------
DROP SEQUENCE IF EXISTS "t_isolation_history_id_seq" CASCADE;
...
CREATE TABLE "t_isolation_history" (
  ...
  "action" "t_isolation_history_action" NOT NULL DEFAULT '未知'::t_isolation_history_action,
...
-- ============================
-- ----------------------------
-- Primary Keys structure for table t_isolation_history
-- ----------------------------
