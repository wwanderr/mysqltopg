...
-- ----------------------------
DROP SEQUENCE IF EXISTS "t_scan_job_id_seq" CASCADE;
...
CREATE TABLE "t_scan_job" (
  ...
  "scan_scope" "t_scan_job_scan_scope" NOT NULL DEFAULT 'full'::t_scan_job_scan_scope,
  ...
  "next_scan_time" timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- ============================
-- ----------------------------
-- Primary Keys structure for table t_scan_job
-- ----------------------------
