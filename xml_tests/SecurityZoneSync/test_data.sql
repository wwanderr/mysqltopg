...
INSERT INTO bigdata_web.t_asset_info ("assetIp", "assetIpNum") VALUES
('192.168.1.50', inet_aton('192.168.1.50')),    -- 生产环境资产
('192.168.1.100', inet_aton('192.168.1.100')),  -- 生产环境资产
('192.168.10.20', inet_aton('192.168.10.20')),  -- 办公网络资产
('192.168.11.30', inet_aton('192.168.11.30')),  -- 办公网络资产（第2段）
('192.168.100.50', inet_aton('192.168.100.50')); -- 测试环境资产
